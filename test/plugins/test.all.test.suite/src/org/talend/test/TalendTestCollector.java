...
public class TalendTestCollector {
	...
	/**
	 * System property key to specify string representing the prefix of plugin
	 * names to look for test classes, this may be empty.
	 * 
	...
	/**
	 * System property key to specify string representing the suffix of plugin
	 * names to look for test classes, this may be empty
	 * 
	...
	/**
	 * System property key to specify string representing the package prefix
	 * list value, this may be empty.
	 * 
	 * @see GenericTestsJUnit4Suite.DEFAULT_PLUGIN_SUFFIX
	 */
	...
	/**
	 * System property key to specify string representing the filter to select
	 * test classes, you may use the * wildcard.
	 * 
	...
	/**
	 * System property key to specify a boolean (false or true) to use only
	 * Eclipse fragment instead of all plugins. the default value is true
	 * 
	 */
	...
	public Class<?>[] getTests() {
		...
		Class<?>[] allCollectedTestClasses = testCollector
				.collectTestsClasses(System.getProperty(TEST_FEATURE_LIST_SP,
						DEFAULT_FEATURE_LIST), System.getProperty(
						TEST_PLUGIN_PREFIX_SP, DEFAULT_PLUGIN_PREFIX), System
						.getProperty(TEST_PLUGIN_SUFFIX_SP,
								DEFAULT_PLUGIN_SUFFIX), System.getProperty(
						TEST_PACKAGE_PREFIX_SP, DEFAULT_PACKAGE_PREFIX),
						System.getProperty(TEST_CLASS_FILTER_SP,
								DEFAULT_CLASS_FILTER), Boolean
								.parseBoolean(System.getProperty(
										ONLY_USE_FRAGMENT_SP, "true")));
