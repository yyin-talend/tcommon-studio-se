...
//
// ============================================================================
package org.talend.resources.i18n;
...
public class Messages extends MessagesCore {
    ...
    public static String getString(String key) {
        return getString(key, ResourcesPlugin.PLUGIN_ID, resourceBundle);
    }
    ...
    public static String getString(String key, Object... args) {
        return MessagesCore.getString(key, ResourcesPlugin.PLUGIN_ID, resourceBundle, args);
    }
}
