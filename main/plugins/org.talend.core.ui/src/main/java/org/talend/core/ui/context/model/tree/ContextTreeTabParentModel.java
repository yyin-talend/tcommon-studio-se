 ...
 */
public class ContextTreeTabParentModel extends ContextTabParentModel {

    public ContextTreeTabParentModel() {
        super();
    }

    public ContextTreeTabParentModel(String sourceId, String sourceName) {
