...
public class XmlFileConnectionImpl extends ConnectionImpl implements XmlFileConnection {
	...
	public void setGuess(boolean newGuess) {
		...
		guess = newGuess;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.XML_FILE_CONNECTION__GUESS,
					oldGuess, guess));
	}
	...
	public EList<XmlXPathLoopDescriptor> getSchema() {
		if (schema == null) {
			schema = new EObjectContainmentWithInverseEList.Resolving<XmlXPathLoopDescriptor>(
					XmlXPathLoopDescriptor.class, this, ConnectionPackage.XML_FILE_CONNECTION__SCHEMA,
					ConnectionPackage.XML_XPATH_LOOP_DESCRIPTOR__CONNECTION);
		}
		return schema;
	}
	...
	public void setEncoding(String newEncoding) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.XML_FILE_CONNECTION__ENCODING,
	...
	public EList<XMLFileNode> getLoop() {
		if (loop == null) {
			loop = new EObjectContainmentEList<XMLFileNode>(XMLFileNode.class, this,
					ConnectionPackage.XML_FILE_CONNECTION__LOOP);
		}
		return loop;
	}
	...
	public void setOutputFilePath(String newOutputFilePath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.XML_FILE_CONNECTION__OUTPUT_FILE_PATH, oldOutputFilePath, outputFilePath));
	}
	...
	public void setTargetNameSpace(String newTargetNameSpace) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.XML_FILE_CONNECTION__TARGET_NAME_SPACE, oldTargetNameSpace, targetNameSpace));
	}
