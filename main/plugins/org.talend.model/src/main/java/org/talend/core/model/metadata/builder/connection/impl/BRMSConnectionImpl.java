...
public class BRMSConnectionImpl extends ConnectionImpl implements BRMSConnection {
	...
	public void setXmlField(String newXmlField) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.BRMS_CONNECTION__XML_FIELD,
					oldXmlField, xmlField));
	}
	...
	public void setUrlName(String newUrlName) {
		...
		urlName = newUrlName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.BRMS_CONNECTION__URL_NAME,
					oldUrlName, urlName));
	}
	...
	public void setClassName(String newClassName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.BRMS_CONNECTION__CLASS_NAME,
	...
	public void setModuleUsed(String newModuleUsed) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.BRMS_CONNECTION__MODULE_USED,
					oldModuleUsed, moduleUsed));
	}
	...
	public void setPackage(String newPackage) {
		...
		package_ = newPackage;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.BRMS_CONNECTION__PACKAGE,
					oldPackage, package_));
	}
	...
	public boolean eIsSet(int featureID) {
		...
		case ConnectionPackage.BRMS_CONNECTION__TAC_WEBAPP_NAME:
			return TAC_WEBAPP_NAME_EDEFAULT == null ? tacWebappName != null
					: !TAC_WEBAPP_NAME_EDEFAULT.equals(tacWebappName);
		case ConnectionPackage.BRMS_CONNECTION__CLASS_NAME:
