...
public class HL7FileNodeImpl extends EObjectImpl implements HL7FileNode {
	...
	public void setFilePath(String newFilePath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.HL7_FILE_NODE__FILE_PATH,
	...
	public void setOrder(int newOrder) {
		...
		order = newOrder;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.HL7_FILE_NODE__ORDER, oldOrder,
					order));
	}
	...
	public void setAttribute(String newAttribute) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.HL7_FILE_NODE__ATTRIBUTE,
	...
	public void setRepeatable(boolean newRepeatable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.HL7_FILE_NODE__REPEATABLE,
	...
	public boolean eIsSet(int featureID) {
		...
		case ConnectionPackage.HL7_FILE_NODE__RELATED_COLUMN:
			return RELATED_COLUMN_EDEFAULT == null ? relatedColumn != null
					: !RELATED_COLUMN_EDEFAULT.equals(relatedColumn);
		case ConnectionPackage.HL7_FILE_NODE__REPEATABLE:
