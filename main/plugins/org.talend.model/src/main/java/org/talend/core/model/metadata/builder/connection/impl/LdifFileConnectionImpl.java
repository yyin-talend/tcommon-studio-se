...
public class LdifFileConnectionImpl extends ConnectionImpl implements LdifFileConnection {
	...
	public void setFilePath(String newFilePath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.LDIF_FILE_CONNECTION__FILE_PATH,
	...
	public void setUseLimit(boolean newUseLimit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.LDIF_FILE_CONNECTION__USE_LIMIT,
	...
	public void setServer(String newServer) {
		...
		server = newServer;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.LDIF_FILE_CONNECTION__SERVER,
					oldServer, server));
	}
