...
public class TdXmlElementTypeImpl extends ElementTypeImpl implements TdXmlElementType {
	...
	public TdXmlSchema getOwnedDocument() {
		if (ownedDocument != null && ownedDocument.eIsProxy()) {
			...
			if (ownedDocument != oldOwnedDocument) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							XmlPackage.TD_XML_ELEMENT_TYPE__OWNED_DOCUMENT, oldOwnedDocument, ownedDocument));
			}
		}
	...
	public void setJavaType(String newJavaType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XmlPackage.TD_XML_ELEMENT_TYPE__JAVA_TYPE,
		...
		if (xmlContent != null && xmlContent.eIsProxy()) {
			...
			if (xmlContent != oldXmlContent) {
				...
				if (newXmlContent.eInternalContainer() == null) {
					msgs = newXmlContent.eInverseAdd(this,
				...
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							XmlPackage.TD_XML_ELEMENT_TYPE__XML_CONTENT, oldXmlContent, xmlContent));
			}
		}
		return xmlContent;
	}
	...
	public void setXmlContent(TdXmlContent newXmlContent) {
		if (newXmlContent != xmlContent) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, XmlPackage.TD_XML_ELEMENT_TYPE__XML_CONTENT,
	...
	public String getContentType() {
		TaggedValue tv = TaggedValueHelper.getTaggedValue(TaggedValueHelper.DATA_CONTENT_TYPE_TAGGED_VAL,
				this.getTaggedValue());
		if (tv == null) {
			return "";
		}
