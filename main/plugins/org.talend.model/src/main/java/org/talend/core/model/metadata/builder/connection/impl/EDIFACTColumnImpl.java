...
public class EDIFACTColumnImpl extends MetadataColumnImpl implements EDIFACTColumn {
	...
	public void setEDIXpath(String newEDIXpath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.EDIFACT_COLUMN__EDI_XPATH,
					oldEDIXpath, ediXpath));
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case ConnectionPackage.EDIFACT_COLUMN__EDI_COLUMN_NAME:
			return EDI_COLUMN_NAME_EDEFAULT == null ? ediColumnName != null
					: !EDI_COLUMN_NAME_EDEFAULT.equals(ediColumnName);
		case ConnectionPackage.EDIFACT_COLUMN__EDI_XPATH:
