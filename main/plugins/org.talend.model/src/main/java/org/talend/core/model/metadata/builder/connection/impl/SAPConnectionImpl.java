...
public class SAPConnectionImpl extends ConnectionImpl implements SAPConnection {
	...
	public void setHost(String newHost) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.SAP_CONNECTION__HOST, oldHost,
					host));
	}
	...
	public void setUsername(String newUsername) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.SAP_CONNECTION__USERNAME,
	...
	public void setPassword(String newPassword) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.SAP_CONNECTION__PASSWORD,
	...
	public void setClient(String newClient) {
		...
		client = newClient;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.SAP_CONNECTION__CLIENT, oldClient,
					client));
	}
	...
	public void setLanguage(String newLanguage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.SAP_CONNECTION__LANGUAGE,
	...
	public void setJcoVersion(String newJcoVersion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.SAP_CONNECTION__JCO_VERSION,
					oldJcoVersion, jcoVersion));
	}
