...
public class TdSqlDataTypeImpl extends SQLSimpleTypeImpl implements TdSqlDataType {
	...
	public void setNullable(NullableType newNullable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RelationalPackage.TD_SQL_DATA_TYPE__NULLABLE,
	...
	public void setUnsignedAttribute(boolean newUnsignedAttribute) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RelationalPackage.TD_SQL_DATA_TYPE__UNSIGNED_ATTRIBUTE, oldUnsignedAttribute, unsignedAttribute));
	}
	...
	public void setSearchable(short newSearchable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RelationalPackage.TD_SQL_DATA_TYPE__SEARCHABLE,
					oldSearchable, searchable));
	}
	...
	public boolean eIsSet(int featureID) {
		...
		case RelationalPackage.TD_SQL_DATA_TYPE__LOCAL_TYPE_NAME:
			return LOCAL_TYPE_NAME_EDEFAULT == null ? localTypeName != null
					: !LOCAL_TYPE_NAME_EDEFAULT.equals(localTypeName);
		case RelationalPackage.TD_SQL_DATA_TYPE__SEARCHABLE:
