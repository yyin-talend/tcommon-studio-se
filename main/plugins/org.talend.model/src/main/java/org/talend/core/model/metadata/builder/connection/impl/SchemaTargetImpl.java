		...
		if (newSchema != eInternalContainer()
			...
			if (newSchema != null)
				msgs = ((InternalEObject) newSchema).eInverseAdd(this,
						ConnectionPackage.XML_XPATH_LOOP_DESCRIPTOR__SCHEMA_TARGETS, XmlXPathLoopDescriptor.class,
						msgs);
			msgs = basicSetSchema(newSchema, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.SCHEMA_TARGET__SCHEMA, newSchema,
					newSchema));
	}
