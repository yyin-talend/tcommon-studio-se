...
public class TdTableImpl extends MetadataTableImpl implements TdTable {
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RelationalPackage.TD_TABLE__TYPE, oldType,
							type));
			}
		}
		return type;
	...
	public NotificationChain basicSetType(SQLStructuredType newType, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					RelationalPackage.TD_TABLE__TYPE, oldType, newType);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setIsTemporary(boolean newIsTemporary) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RelationalPackage.TD_TABLE__IS_TEMPORARY,
					oldIsTemporary, isTemporary));
	}
	...
	public void setTemporaryScope(String newTemporaryScope) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RelationalPackage.TD_TABLE__TEMPORARY_SCOPE,
					oldTemporaryScope, temporaryScope));
	}
	...
	public void setIsSystem(boolean newIsSystem) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RelationalPackage.TD_TABLE__IS_SYSTEM, oldIsSystem,
					isSystem));
	}
	...
	public EList<Trigger> getTrigger() {
		if (trigger == null) {
			trigger = new EObjectWithInverseResolvingEList<Trigger>(Trigger.class, this,
					RelationalPackage.TD_TABLE__TRIGGER,
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		...
		case RelationalPackage.TD_TABLE__OPTION_SCOPE_COLUMN:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getOptionScopeColumn()).basicAdd(otherEnd,
					msgs);
	...
	public boolean eIsSet(int featureID) {
		...
		case RelationalPackage.TD_TABLE__TEMPORARY_SCOPE:
			return TEMPORARY_SCOPE_EDEFAULT == null ? temporaryScope != null
					: !TEMPORARY_SCOPE_EDEFAULT.equals(temporaryScope);
		case RelationalPackage.TD_TABLE__IS_SYSTEM:
