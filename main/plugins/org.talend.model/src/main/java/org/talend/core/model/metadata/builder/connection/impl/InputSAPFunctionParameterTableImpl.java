 ...
 * @generated
 */
public class InputSAPFunctionParameterTableImpl extends SAPFunctionParameterTableImpl
		implements InputSAPFunctionParameterTable {
	...
	public void setFunctionUnit(SAPFunctionUnit newFunctionUnit) {
		if (newFunctionUnit != eInternalContainer()
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.INPUT_SAP_FUNCTION_PARAMETER_TABLE__FUNCTION_UNIT, newFunctionUnit,
					newFunctionUnit));
	}
