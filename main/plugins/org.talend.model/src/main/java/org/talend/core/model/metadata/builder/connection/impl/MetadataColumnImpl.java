...
public class MetadataColumnImpl extends AbstractMetadataObjectImpl implements MetadataColumn {
	...
	public void setOwnerScope(ScopeKind newOwnerScope) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.METADATA_COLUMN__OWNER_SCOPE,
					oldOwnerScope, ownerScope));
	}
	...
	public void setOwner(Classifier newOwner) {
		if (newOwner != eInternalContainer()
			...
			if (newOwner != null)
				msgs = ((InternalEObject) newOwner).eInverseAdd(this, CorePackage.CLASSIFIER__FEATURE, Classifier.class,
						msgs);
			msgs = basicSetOwner(newOwner, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.METADATA_COLUMN__OWNER, newOwner,
					newOwner));
	}
	...
	public EList<ClassifierFeatureMap> getCfMap() {
		if (cfMap == null) {
			cfMap = new EObjectWithInverseResolvingEList.ManyInverse<ClassifierFeatureMap>(ClassifierFeatureMap.class,
					this, ConnectionPackage.METADATA_COLUMN__CF_MAP,
					TransformationPackage.CLASSIFIER_FEATURE_MAP__FEATURE);
		}
		return cfMap;
	}
	...
	public void setOrdering(OrderingKind newOrdering) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.METADATA_COLUMN__ORDERING,
	...
	public Classifier getType() {
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ConnectionPackage.METADATA_COLUMN__TYPE,
							oldType, type));
			}
		}
		return type;
	...
	public void setType(Classifier newType) {
		if (newType != type) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.METADATA_COLUMN__TYPE, newType,
					newType));
	}
	...
	public EList<KeyRelationship> getKeyRelationship() {
		if (keyRelationship == null) {
			keyRelationship = new EObjectWithInverseResolvingEList.ManyInverse<KeyRelationship>(KeyRelationship.class,
					this, ConnectionPackage.METADATA_COLUMN__KEY_RELATIONSHIP,
					KeysindexesPackage.KEY_RELATIONSHIP__FEATURE);
		}
	...
	public EList<Remap> getRemap() {
		if (remap == null) {
			remap = new EObjectWithInverseResolvingEList<Remap>(Remap.class, this,
					ConnectionPackage.METADATA_COLUMN__REMAP, DmsiiPackage.REMAP__STRUCTURE);
		}
		return remap;
	}
	...
	public void setSourceType(String newSourceType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.METADATA_COLUMN__SOURCE_TYPE,
	...
	public void setTalendType(String newTalendType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.METADATA_COLUMN__TALEND_TYPE,
					oldTalendType, talendType));
	}
	...
	public void setNullable(boolean newNullable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.METADATA_COLUMN__NULLABLE,
	...
	public void setTable(MetadataTable newTable) {
		...
		setOwner(newTable);
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.METADATA_COLUMN__TABLE, oldOwner,
					newTable));
		} // else no notification required
	}
	...
	public void setOriginalField(String newOriginalField) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.METADATA_COLUMN__ORIGINAL_FIELD,
					oldName, newOriginalField));
		} // else no notification required
	}
	...
	public void setPattern(String newPattern) {
		...
		pattern = newPattern;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.METADATA_COLUMN__PATTERN,
					oldPattern, pattern));
	}
	...
	public void setLength(long newLength) {
		...
		length = newLength;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.METADATA_COLUMN__LENGTH, oldLength,
					length));
	}
	...
	public void setPrecision(long newPrecision) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.METADATA_COLUMN__PRECISION,
	...
	public void setScale(long newScale) {
		...
		scale = newScale;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.METADATA_COLUMN__SCALE, oldScale,
					scale));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		...
		case ConnectionPackage.METADATA_COLUMN__DISCRIMINATED_UNION:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getDiscriminatedUnion()).basicAdd(otherEnd,
					msgs);
	...
	public boolean eIsSet(int featureID) {
		...
		case ConnectionPackage.METADATA_COLUMN__DEFAULT_VALUE:
			return DEFAULT_VALUE_EDEFAULT == null ? getDefaultValue() != null
					: !DEFAULT_VALUE_EDEFAULT.equals(getDefaultValue());
		case ConnectionPackage.METADATA_COLUMN__TALEND_TYPE:
		...
		case ConnectionPackage.METADATA_COLUMN__RELATED_ENTITY:
			return RELATED_ENTITY_EDEFAULT == null ? relatedEntity != null
					: !RELATED_ENTITY_EDEFAULT.equals(relatedEntity);
		case ConnectionPackage.METADATA_COLUMN__RELATIONSHIP_TYPE:
