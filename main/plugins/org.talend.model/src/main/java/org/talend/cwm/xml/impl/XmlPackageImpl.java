...
public class XmlPackageImpl extends EPackageImpl implements XmlPackage {
	...
	public static XmlPackage init() {
		...
		Object registeredXmlPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		XmlPackageImpl theXmlPackage = registeredXmlPackage instanceof XmlPackageImpl
				? (XmlPackageImpl) registeredXmlPackage
				: new XmlPackageImpl();
	...
	public void initializePackageContents() {
		...
		initEReference(getTdXmlElementType_XsdElementDeclaration(), ecorePackage.getEObject(), null,
				"xsdElementDeclaration", null, 0, 1, TdXmlElementType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
		...
		addEOperation(tdXmlElementTypeEClass, theCorePackage.getString(), "getContentType", 0, 1, IS_UNIQUE,
				IS_ORDERED);
		...
		initEReference(getTdXmlContent_XmlElements(), this.getTdXmlElementType(), null, "xmlElements", null, 0, -1,
				TdXmlContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(tdXmlSchemaEClass, TdXmlSchema.class, "TdXmlSchema", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getTdXmlSchema_XsdFilePath(), theCorePackage.getString(), "xsdFilePath", "", 0, 1,
				TdXmlSchema.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
