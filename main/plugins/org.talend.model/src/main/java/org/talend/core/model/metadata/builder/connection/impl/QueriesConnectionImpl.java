...
public class QueriesConnectionImpl extends EObjectImpl implements QueriesConnection {
	...
	public NotificationChain basicSetConnection(Connection newConnection, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newConnection, ConnectionPackage.QUERIES_CONNECTION__CONNECTION,
				msgs);
		return msgs;
	}
	...
	public void setConnection(Connection newConnection) {
		if (newConnection != eInternalContainer()
				|| (eContainerFeatureID() != ConnectionPackage.QUERIES_CONNECTION__CONNECTION
						&& newConnection != null)) {
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case ConnectionPackage.QUERIES_CONNECTION__CONNECTION:
			return eInternalContainer().eInverseRemove(this, ConnectionPackage.CONNECTION__QUERIES, Connection.class,
					msgs);
		}
