...
public class GenericSchemaConnectionImpl extends ConnectionImpl implements GenericSchemaConnection {
	...
	public void setMappingTypeUsed(boolean newMappingTypeUsed) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.GENERIC_SCHEMA_CONNECTION__MAPPING_TYPE_USED, oldMappingTypeUsed,
					mappingTypeUsed));
	}
	...
	public void setMappingTypeId(String newMappingTypeId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.GENERIC_SCHEMA_CONNECTION__MAPPING_TYPE_ID, oldMappingTypeId, mappingTypeId));
	}
	...
	public boolean eIsSet(int featureID) {
		...
		case ConnectionPackage.GENERIC_SCHEMA_CONNECTION__MAPPING_TYPE_ID:
			return MAPPING_TYPE_ID_EDEFAULT == null ? mappingTypeId != null
					: !MAPPING_TYPE_ID_EDEFAULT.equals(mappingTypeId);
		}
