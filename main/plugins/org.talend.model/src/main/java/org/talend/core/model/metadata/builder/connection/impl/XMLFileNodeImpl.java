...
public class XMLFileNodeImpl extends EObjectImpl implements XMLFileNode {
	...
	public void setAttribute(String newAttribute) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.XML_FILE_NODE__ATTRIBUTE,
	...
	public void setOrder(int newOrder) {
		...
		order = newOrder;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.XML_FILE_NODE__ORDER, oldOrder,
					order));
	}
	...
	public void setType(String newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.XML_FILE_NODE__TYPE, oldType,
					type));
	}
