...
public class FTPConnectionImpl extends ConnectionImpl implements FTPConnection {
	...
	public void setHost(String newHost) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.FTP_CONNECTION__HOST, oldHost,
					host));
	}
	...
	public void setPort(String newPort) {
		...
		port = newPort;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.FTP_CONNECTION__PORT, oldPort,
					port));
	}
	...
	public void setUsername(String newUsername) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.FTP_CONNECTION__USERNAME,
	...
	public void setPassword(String newPassword) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.FTP_CONNECTION__PASSWORD,
	...
	public void setMode(String newMode) {
		...
		mode = newMode;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.FTP_CONNECTION__MODE, oldMode,
					mode));
	}
	...
	public void setSFTP(boolean newSFTP) {
		...
		sftp = newSFTP;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.FTP_CONNECTION__SFTP, oldSFTP,
					sftp));
	}
	...
	public void setFTPS(boolean newFTPS) {
		...
		ftps = newFTPS;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.FTP_CONNECTION__FTPS, oldFTPS,
					ftps));
	}
	...
	public void setMethod(String newMethod) {
		...
		method = newMethod;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.FTP_CONNECTION__METHOD, oldMethod,
					method));
	}
	...
	public void setPrivatekey(String newPrivatekey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.FTP_CONNECTION__PRIVATEKEY,
	...
	public void setPassphrase(String newPassphrase) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.FTP_CONNECTION__PASSPHRASE,
	...
	public void setUsesocks(boolean newUsesocks) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.FTP_CONNECTION__USESOCKS,
					oldUsesocks, usesocks));
	}
	...
	public void setProxyhost(String newProxyhost) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.FTP_CONNECTION__PROXYHOST,
	...
	public void setProxyport(String newProxyport) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.FTP_CONNECTION__PROXYPORT,
	...
	public void setProxyuser(String newProxyuser) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.FTP_CONNECTION__PROXYUSER,
	...
	public void setUseFileNameEncoding(boolean newUseFileNameEncoding) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.FTP_CONNECTION__USE_FILE_NAME_ENCODING, oldUseFileNameEncoding,
					useFileNameEncoding));
	}
	...
	public boolean eIsSet(int featureID) {
		...
		case ConnectionPackage.FTP_CONNECTION__PROXYPASSWORD:
			return PROXYPASSWORD_EDEFAULT == null ? proxypassword != null
					: !PROXYPASSWORD_EDEFAULT.equals(proxypassword);
		case ConnectionPackage.FTP_CONNECTION__CUSTOM_ENCODE:
