...
public class ConditionTypeImpl extends EObjectImpl implements ConditionType {
	...
	public void setInputColumn(String newInputColumn) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.CONDITION_TYPE__INPUT_COLUMN,
					oldInputColumn, inputColumn));
	}
	...
	public void setFunction(Function newFunction) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.CONDITION_TYPE__FUNCTION,
	...
	public void setOperator(Operator newOperator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.CONDITION_TYPE__OPERATOR,
	...
	public void setValue(String newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.CONDITION_TYPE__VALUE, oldValue,
					value));
	}
