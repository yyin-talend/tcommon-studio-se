...
public class CDCTypeImpl extends AbstractMetadataObjectImpl implements CDCType {
	...
	public void setLinkDB(String newLinkDB) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.CDC_TYPE__LINK_DB, oldLinkDB,
					linkDB));
	}
			...
			if (cdcConnection != oldCdcConnection) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ConnectionPackage.CDC_TYPE__CDC_CONNECTION, oldCdcConnection, cdcConnection));
			}
		}
	...
	public void setCdcConnection(CDCConnection newCdcConnection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.CDC_TYPE__CDC_CONNECTION,
	...
	public void setJournalName(String newJournalName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.CDC_TYPE__JOURNAL_NAME,
					oldJournalName, journalName));
	}
