...
public class TdViewImpl extends MetadataTableImpl implements TdView {
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RelationalPackage.TD_VIEW__TYPE, oldType,
							type));
			}
		}
		return type;
	...
	public NotificationChain basicSetType(SQLStructuredType newType, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					RelationalPackage.TD_VIEW__TYPE, oldType, newType);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setIsReadOnly(boolean newIsReadOnly) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RelationalPackage.TD_VIEW__IS_READ_ONLY,
	...
	public void setCheckOption(boolean newCheckOption) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RelationalPackage.TD_VIEW__CHECK_OPTION,
					oldCheckOption, checkOption));
	}
