...
public class RelationalPackageImpl extends EPackageImpl implements RelationalPackage {
	...
	public void initializePackageContents() {
		...
		initEClass(tdColumnEClass, TdColumn.class, "TdColumn", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getTdColumn_SqlDataType(), this.getTdSqlDataType(), null, "sqlDataType", null, 0, 1,
				TdColumn.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES,
		...
		initEClass(tdSqlDataTypeEClass, TdSqlDataType.class, "TdSqlDataType", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getTdSqlDataType_JavaDataType(), ecorePackage.getEInt(), "javaDataType", null, 0, 1,
				TdSqlDataType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getTdSqlDataType_Nullable(), theEnumerationsPackage.getNullableType(), "nullable", null, 0, 1,
				TdSqlDataType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getTdSqlDataType_UnsignedAttribute(), theCorePackage.getBoolean(), "unsignedAttribute", null, 0,
				1, TdSqlDataType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getTdSqlDataType_LocalTypeName(), theCorePackage.getString(), "localTypeName", null, 0, 1,
				TdSqlDataType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getTdSqlDataType_Searchable(), ecorePackage.getEShort(), "searchable", null, 0, 1,
				TdSqlDataType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		initEClass(tdTriggerEClass, TdTrigger.class, "TdTrigger", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);

		initEClass(tdProcedureEClass, TdProcedure.class, "TdProcedure", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		...
		initEAttribute(getTdExpression_ModificationDate(), theCorePackage.getTime(), "modificationDate", null, 0, 1,
				TdExpression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getTdExpression_Name(), theCorePackage.getString(), "name", null, 0, 1, TdExpression.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTdExpression_ExpressionVariableMap(), this.getjavaHashMap(), "expressionVariableMap", null, 0,
				1, TdExpression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
	...
	protected void createGenModelAnnotations() {
		...
		addAnnotation(getTdSqlDataType_UnsignedAttribute(), source,
				new String[] { "documentation", "is it unsigned?" });
