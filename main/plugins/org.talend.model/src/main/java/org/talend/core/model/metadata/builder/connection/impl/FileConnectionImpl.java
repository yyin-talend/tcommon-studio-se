...
public abstract class FileConnectionImpl extends ConnectionImpl implements FileConnection {
	...
	public void setServer(String newServer) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.FILE_CONNECTION__SERVER, oldServer,
					server));
	}
	...
	public void setFilePath(String newFilePath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.FILE_CONNECTION__FILE_PATH,
	...
	public void setFormat(FileFormat newFormat) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.FILE_CONNECTION__FORMAT, oldFormat,
					format));
	}
	...
	public void setEncoding(String newEncoding) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.FILE_CONNECTION__ENCODING,
	...
	public void setFieldSeparatorValue(String newFieldSeparatorValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.FILE_CONNECTION__FIELD_SEPARATOR_VALUE, oldFieldSeparatorValue,
					fieldSeparatorValue));
	}
	...
	public void setRowSeparatorValue(String newRowSeparatorValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.FILE_CONNECTION__ROW_SEPARATOR_VALUE, oldRowSeparatorValue, rowSeparatorValue));
	}
	...
	public void setUseHeader(boolean newUseHeader) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.FILE_CONNECTION__USE_HEADER,
					oldUseHeader, useHeader));
	}
	...
	public void setUseFooter(boolean newUseFooter) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.FILE_CONNECTION__USE_FOOTER,
					oldUseFooter, useFooter));
	}
	...
	public void setUseLimit(boolean newUseLimit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.FILE_CONNECTION__USE_LIMIT,
	...
	public void setLimitValue(String newLimitValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.FILE_CONNECTION__LIMIT_VALUE,
	...
	public void setEscapeType(Escape newEscapeType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.FILE_CONNECTION__ESCAPE_TYPE,
					oldEscapeType, escapeType));
	}
	...
	public void setEscapeChar(String newEscapeChar) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.FILE_CONNECTION__ESCAPE_CHAR,
					oldEscapeChar, escapeChar));
	}
	...
	public void setCsvOption(boolean newCsvOption) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.FILE_CONNECTION__CSV_OPTION,
					oldCsvOption, csvOption));
	}
	...
	public boolean eIsSet(int featureID) {
		...
		case ConnectionPackage.FILE_CONNECTION__TEXT_IDENTIFIER:
			return TEXT_IDENTIFIER_EDEFAULT == null ? textIdentifier != null
					: !TEXT_IDENTIFIER_EDEFAULT.equals(textIdentifier);
		case ConnectionPackage.FILE_CONNECTION__USE_HEADER:
		...
		case ConnectionPackage.FILE_CONNECTION__TEXT_ENCLOSURE:
			return TEXT_ENCLOSURE_EDEFAULT == null ? textEnclosure != null
					: !TEXT_ENCLOSURE_EDEFAULT.equals(textEnclosure);
		case ConnectionPackage.FILE_CONNECTION__CSV_OPTION:
