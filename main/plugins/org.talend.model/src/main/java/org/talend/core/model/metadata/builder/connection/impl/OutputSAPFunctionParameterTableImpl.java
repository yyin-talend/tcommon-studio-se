...
public class OutputSAPFunctionParameterTableImpl extends SAPFunctionParameterTableImpl
    ...
    public SAPFunctionUnit getFunctionUnit() {
        if (eContainerFeatureID() != ConnectionPackage.OUTPUT_SAP_FUNCTION_PARAMETER_TABLE__FUNCTION_UNIT)
            return null;
    ...
    public NotificationChain basicSetFunctionUnit(SAPFunctionUnit newFunctionUnit, NotificationChain msgs) {
        msgs = eBasicSetContainer((InternalEObject) newFunctionUnit,
                ConnectionPackage.OUTPUT_SAP_FUNCTION_PARAMETER_TABLE__FUNCTION_UNIT, msgs);
        return msgs;
    }
        ...
        if (newFunctionUnit != eInternalContainer()
            ...
            if (newFunctionUnit != null)
                msgs = ((InternalEObject) newFunctionUnit).eInverseAdd(this,
                        ConnectionPackage.SAP_FUNCTION_UNIT__OUTPUT_PARAMETER_TABLE, SAPFunctionUnit.class, msgs);
            msgs = basicSetFunctionUnit(newFunctionUnit, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ConnectionPackage.OUTPUT_SAP_FUNCTION_PARAMETER_TABLE__FUNCTION_UNIT, newFunctionUnit, newFunctionUnit));
    }
    ...
    public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
        ...
        case ConnectionPackage.OUTPUT_SAP_FUNCTION_PARAMETER_TABLE__FUNCTION_UNIT:
            return eInternalContainer().eInverseRemove(this, ConnectionPackage.SAP_FUNCTION_UNIT__OUTPUT_PARAMETER_TABLE,
