...
public class SalesforceSchemaConnectionImpl extends ConnectionImpl implements SalesforceSchemaConnection {
	...
	public void setUserName(String newUserName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.SALESFORCE_SCHEMA_CONNECTION__USER_NAME, oldUserName, userName));
	}
	...
	public void setPassword(String newPassword) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.SALESFORCE_SCHEMA_CONNECTION__PASSWORD, oldPassword, password));
	}
	...
	public void setModuleName(String newModuleName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.SALESFORCE_SCHEMA_CONNECTION__MODULE_NAME, oldModuleName, moduleName));
	}
	...
	public void setQueryCondition(String newQueryCondition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.SALESFORCE_SCHEMA_CONNECTION__QUERY_CONDITION, oldQueryCondition,
					queryCondition));
	}
	...
	public void setUseProxy(boolean newUseProxy) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.SALESFORCE_SCHEMA_CONNECTION__USE_PROXY, oldUseProxy, useProxy));
	}
	...
	public void setProxyHost(String newProxyHost) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.SALESFORCE_SCHEMA_CONNECTION__PROXY_HOST, oldProxyHost, proxyHost));
	}
	...
	public void setProxyPort(String newProxyPort) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.SALESFORCE_SCHEMA_CONNECTION__PROXY_PORT, oldProxyPort, proxyPort));
	}
	...
	public void setProxyUsername(String newProxyUsername) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.SALESFORCE_SCHEMA_CONNECTION__PROXY_USERNAME, oldProxyUsername, proxyUsername));
	}
	...
	public void setProxyPassword(String newProxyPassword) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.SALESFORCE_SCHEMA_CONNECTION__PROXY_PASSWORD, oldProxyPassword, proxyPassword));
	}
	...
	public void setBatchSize(String newBatchSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.SALESFORCE_SCHEMA_CONNECTION__BATCH_SIZE, oldBatchSize, batchSize));
	}
	...
	public void setUseHttpProxy(boolean newUseHttpProxy) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.SALESFORCE_SCHEMA_CONNECTION__USE_HTTP_PROXY, oldUseHttpProxy, useHttpProxy));
	}
	...
	public void setUseAlphbet(boolean newUseAlphbet) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.SALESFORCE_SCHEMA_CONNECTION__USE_ALPHBET, oldUseAlphbet, useAlphbet));
	}
	...
	public void setTimeOut(String newTimeOut) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.SALESFORCE_SCHEMA_CONNECTION__TIME_OUT, oldTimeOut, timeOut));
	}
	...
	public EList<SalesforceModuleUnit> getModules() {
		if (modules == null) {
			modules = new EObjectContainmentWithInverseEList.Resolving<SalesforceModuleUnit>(SalesforceModuleUnit.class,
					this, ConnectionPackage.SALESFORCE_SCHEMA_CONNECTION__MODULES,
	...
	public void setWebServiceUrlTextForOAuth(String newWebServiceUrlTextForOAuth) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.SALESFORCE_SCHEMA_CONNECTION__WEB_SERVICE_URL_TEXT_FOR_OAUTH,
					oldWebServiceUrlTextForOAuth, webServiceUrlTextForOAuth));
	}
	...
	public void setConsumeKey(String newConsumeKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.SALESFORCE_SCHEMA_CONNECTION__CONSUME_KEY, oldConsumeKey, consumeKey));
	}
	...
	public void setConsumeSecret(String newConsumeSecret) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.SALESFORCE_SCHEMA_CONNECTION__CONSUME_SECRET, oldConsumeSecret, consumeSecret));
	}
	...
	public void setCallbackHost(String newCallbackHost) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.SALESFORCE_SCHEMA_CONNECTION__CALLBACK_HOST, oldCallbackHost, callbackHost));
	}
	...
	public void setCallbackPort(String newCallbackPort) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.SALESFORCE_SCHEMA_CONNECTION__CALLBACK_PORT, oldCallbackPort, callbackPort));
	}
	...
	public void setSalesforceVersion(String newSalesforceVersion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.SALESFORCE_SCHEMA_CONNECTION__SALESFORCE_VERSION, oldSalesforceVersion,
					salesforceVersion));
	}
	...
	public void setLoginType(String newLoginType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.SALESFORCE_SCHEMA_CONNECTION__LOGIN_TYPE, oldLoginType, loginType));
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case ConnectionPackage.SALESFORCE_SCHEMA_CONNECTION__WEB_SERVICE_URL:
			return WEB_SERVICE_URL_EDEFAULT == null ? webServiceUrl != null
					: !WEB_SERVICE_URL_EDEFAULT.equals(webServiceUrl);
		case ConnectionPackage.SALESFORCE_SCHEMA_CONNECTION__USER_NAME:
		...
		case ConnectionPackage.SALESFORCE_SCHEMA_CONNECTION__QUERY_CONDITION:
			return QUERY_CONDITION_EDEFAULT == null ? queryCondition != null
					: !QUERY_CONDITION_EDEFAULT.equals(queryCondition);
		case ConnectionPackage.SALESFORCE_SCHEMA_CONNECTION__USE_CUSTOM_MODULE_NAME:
		...
		case ConnectionPackage.SALESFORCE_SCHEMA_CONNECTION__PROXY_USERNAME:
			return PROXY_USERNAME_EDEFAULT == null ? proxyUsername != null
					: !PROXY_USERNAME_EDEFAULT.equals(proxyUsername);
		case ConnectionPackage.SALESFORCE_SCHEMA_CONNECTION__PROXY_PASSWORD:
			return PROXY_PASSWORD_EDEFAULT == null ? proxyPassword != null
					: !PROXY_PASSWORD_EDEFAULT.equals(proxyPassword);
		case ConnectionPackage.SALESFORCE_SCHEMA_CONNECTION__BATCH_SIZE:
		...
		case ConnectionPackage.SALESFORCE_SCHEMA_CONNECTION__CONSUME_SECRET:
			return CONSUME_SECRET_EDEFAULT == null ? consumeSecret != null
					: !CONSUME_SECRET_EDEFAULT.equals(consumeSecret);
		case ConnectionPackage.SALESFORCE_SCHEMA_CONNECTION__CALLBACK_HOST:
