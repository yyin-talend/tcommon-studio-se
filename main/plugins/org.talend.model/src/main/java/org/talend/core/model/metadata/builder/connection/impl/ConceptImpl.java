...
public class ConceptImpl extends TdTableImpl implements Concept {
	...
	public void setLoopExpression(String newLoopExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.CONCEPT__LOOP_EXPRESSION,
	...
	public EList<XMLFileNode> getRoot() {
		if (root == null) {
			root = new EObjectContainmentEList.Resolving<XMLFileNode>(XMLFileNode.class, this,
					ConnectionPackage.CONCEPT__ROOT);
		}
		return root;
	}
	...
	public void setConceptType(MdmConceptType newConceptType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.CONCEPT__CONCEPT_TYPE,
	...
	public void setXPathPrefix(String newXPathPrefix) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.CONCEPT__XPATH_PREFIX,
					oldXPathPrefix, xPathPrefix));
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case ConnectionPackage.CONCEPT__LOOP_EXPRESSION:
			return LOOP_EXPRESSION_EDEFAULT == null ? loopExpression != null
					: !LOOP_EXPRESSION_EDEFAULT.equals(loopExpression);
		case ConnectionPackage.CONCEPT__LOOP_LIMIT:
