...
public class HL7ConnectionImpl extends FileConnectionImpl implements HL7Connection {
	...
	public void setStartChar(String newStartChar) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.HL7_CONNECTION__START_CHAR,
	...
	public void setEndChar(String newEndChar) {
		...
		endChar = newEndChar;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.HL7_CONNECTION__END_CHAR,
					oldEndChar, endChar));
	}
