...
public class ConnectionImpl extends AbstractMetadataObjectImpl implements Connection {
	...
	public void setPathname(String newPathname) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.CONNECTION__PATHNAME, oldPathname,
					pathname));
	}
	...
	public void setMachine(Machine newMachine) {
		if (newMachine != eInternalContainer()
			...
			if (newMachine != null)
				msgs = ((InternalEObject) newMachine).eInverseAdd(this,
						SoftwaredeploymentPackage.MACHINE__DEPLOYED_COMPONENT, Machine.class, msgs);
			msgs = basicSetMachine(newMachine, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.CONNECTION__MACHINE, newMachine,
					newMachine));
	}
		...
		if (newComponent != component) {
			...
			if (component != null)
				msgs = ((InternalEObject) component).eInverseRemove(this,
						SoftwaredeploymentPackage.COMPONENT__DEPLOYMENT, Component.class, msgs);
	...
	public EList<ProviderConnection> getClientConnection() {
		if (clientConnection == null) {
			clientConnection = new EObjectWithInverseResolvingEList<ProviderConnection>(ProviderConnection.class, this,
					ConnectionPackage.CONNECTION__CLIENT_CONNECTION,
					SoftwaredeploymentPackage.PROVIDER_CONNECTION__DATA_MANAGER);
		}
	...
	public EList<ProviderConnection> getResourceConnection() {
		if (resourceConnection == null) {
			resourceConnection = new EObjectContainmentWithInverseEList<ProviderConnection>(ProviderConnection.class,
					this, ConnectionPackage.CONNECTION__RESOURCE_CONNECTION,
	...
	public void setVersion(String newVersion) {
		...
		version = newVersion;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.CONNECTION__VERSION, oldVersion,
					version));
	}
	...
	public QueriesConnection getQueries() {
		if (queries != null && queries.eIsProxy()) {
			...
			if (queries != oldQueries) {
				...
				NotificationChain msgs = oldQueries.eInverseRemove(this,
						ConnectionPackage.QUERIES_CONNECTION__CONNECTION, QueriesConnection.class, null);
				...
				if (msgs != null)
					msgs.dispatch();
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ConnectionPackage.CONNECTION__QUERIES,
							oldQueries, queries));
			}
		}
		return queries;
	...
	public NotificationChain basicSetQueries(QueriesConnection newQueries, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.CONNECTION__QUERIES, oldQueries, newQueries);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newQueries != queries) {
			...
			if (queries != null)
				msgs = ((InternalEObject) queries).eInverseRemove(this,
						ConnectionPackage.QUERIES_CONNECTION__CONNECTION, QueriesConnection.class, msgs);
			if (newQueries != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.CONNECTION__QUERIES, newQueries,
					newQueries));
	}
	...
	public void setContextMode(boolean newContextMode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.CONNECTION__CONTEXT_MODE,
					oldContextMode, contextMode));
	}
	...
	public void setContextId(String newContextId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.CONNECTION__CONTEXT_ID,
	...
	public void setContextName(String newContextName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.CONNECTION__CONTEXT_NAME,
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		...
		case ConnectionPackage.CONNECTION__DEPLOYED_SOFTWARE_SYSTEM:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getDeployedSoftwareSystem()).basicAdd(otherEnd,
					msgs);
		...
		case ConnectionPackage.CONNECTION__RESOURCE_CONNECTION:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getResourceConnection()).basicAdd(otherEnd,
					msgs);
	...
	public boolean eIsSet(int featureID) {
		...
		case ConnectionPackage.CONNECTION__COMP_PROPERTIES:
			return COMP_PROPERTIES_EDEFAULT == null ? compProperties != null
					: !COMP_PROPERTIES_EDEFAULT.equals(compProperties);
		}
