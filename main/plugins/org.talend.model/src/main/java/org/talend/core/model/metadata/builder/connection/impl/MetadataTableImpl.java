...
public class MetadataTableImpl extends AbstractMetadataObjectImpl implements MetadataTable {
	...
	public void setIsAbstract(boolean newIsAbstract) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.METADATA_TABLE__IS_ABSTRACT,
	...
	public EList<ClassifierFeatureMap> getCfMap() {
		if (cfMap == null) {
			cfMap = new EObjectWithInverseResolvingEList.ManyInverse<ClassifierFeatureMap>(ClassifierFeatureMap.class,
					this, ConnectionPackage.METADATA_TABLE__CF_MAP,
					TransformationPackage.CLASSIFIER_FEATURE_MAP__CLASSIFIER);
		}
		return cfMap;
	}
	...
	public EList<Domain> getDomain() {
		if (domain == null) {
			domain = new EObjectWithInverseResolvingEList<Domain>(Domain.class, this,
					ConnectionPackage.METADATA_TABLE__DOMAIN, ErPackage.DOMAIN__BASE_TYPE);
		}
		return domain;
	}
	...
	public EList<Index> getIndex() {
		if (index == null) {
			index = new EObjectWithInverseResolvingEList<Index>(Index.class, this,
					ConnectionPackage.METADATA_TABLE__INDEX, KeysindexesPackage.INDEX__SPANNED_CLASS);
		}
		return index;
	}
	...
	public void setSourceName(String newSourceName) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.METADATA_TABLE__SOURCE_NAME,
					oldSourceName, newSourceName));
		}
	}
	...
	public void setTableType(String newTableType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.METADATA_TABLE__TABLE_TYPE,
	...
	public void setAttachedCDC(boolean newAttachedCDC) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.METADATA_TABLE__ATTACHED_CDC,
					oldAttachedCDC, attachedCDC));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		...
		case ConnectionPackage.METADATA_TABLE__STRUCTURAL_FEATURE:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getStructuralFeature()).basicAdd(otherEnd,
					msgs);
	...
	public boolean eIsSet(int featureID) {
		...
		case ConnectionPackage.METADATA_TABLE__SOURCE_NAME:
			return SOURCE_NAME_EDEFAULT == null ? getSourceName() != null
					: !SOURCE_NAME_EDEFAULT.equals(getSourceName());
		case ConnectionPackage.METADATA_TABLE__TABLE_TYPE:
