...
public class SAPFunctionParameterColumnImpl extends AbstractMetadataObjectImpl implements SAPFunctionParameterColumn {
	...
	public void setDataType(String newDataType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.SAP_FUNCTION_PARAMETER_COLUMN__DATA_TYPE, oldDataType, dataType));
	}
	...
	public void setLength(String newLength) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.SAP_FUNCTION_PARAMETER_COLUMN__LENGTH, oldLength, length));
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.SAP_FUNCTION_PARAMETER_COLUMN__VALUE, oldValue, value));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetParameterTable(SAPFunctionParameterTable newParameterTable,
	...
	public void setParameterTable(SAPFunctionParameterTable newParameterTable) {
		if (newParameterTable != eInternalContainer()
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.SAP_FUNCTION_PARAMETER_COLUMN__PARAMETER_TABLE, newParameterTable,
					newParameterTable));
	}
