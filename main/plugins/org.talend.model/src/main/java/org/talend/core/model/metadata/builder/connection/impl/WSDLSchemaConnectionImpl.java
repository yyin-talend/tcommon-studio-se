...
public class WSDLSchemaConnectionImpl extends ConnectionImpl implements WSDLSchemaConnection {
	...
	public void setWSDL(String newWSDL) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.WSDL_SCHEMA_CONNECTION__WSDL,
					oldWSDL, wsdl));
	}
	...
	public void setProxyPassword(String newProxyPassword) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.WSDL_SCHEMA_CONNECTION__PROXY_PASSWORD, oldProxyPassword, proxyPassword));
	}
	...
	public EList<String> getValue() {
		if (value == null) {
			value = new EDataTypeUniqueEList<String>(String.class, this,
					ConnectionPackage.WSDL_SCHEMA_CONNECTION__VALUE);
		}
		return value;
	}
	...
	public void setEndpointURI(String newEndpointURI) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.WSDL_SCHEMA_CONNECTION__ENDPOINT_URI, oldEndpointURI, endpointURI));
	}
	...
	public void setTimeOut(int newTimeOut) {
		...
		timeOut = newTimeOut;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.WSDL_SCHEMA_CONNECTION__TIME_OUT,
					oldTimeOut, timeOut));
	}
	...
	public void setIsInputModel(boolean newIsInputModel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.WSDL_SCHEMA_CONNECTION__IS_INPUT_MODEL, oldIsInputModel, isInputModel));
	}
	...
	public boolean eIsSet(int featureID) {
		...
		case ConnectionPackage.WSDL_SCHEMA_CONNECTION__PORT_NAME_SPACE:
			return PORT_NAME_SPACE_EDEFAULT == null ? portNameSpace != null
					: !PORT_NAME_SPACE_EDEFAULT.equals(portNameSpace);
		case ConnectionPackage.WSDL_SCHEMA_CONNECTION__PORT_NAME:
	...
	public void setWSDLModel(Boolean newInputModel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.WSDL_SCHEMA_CONNECTION__IS_INPUT_MODEL, oldInputModel, isWSDL));
	}
	...
	public void setPortNameSpace(String newServerNameSpace) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.WSDL_SCHEMA_CONNECTION__PORT_NAME_SPACE, oldPortName, portNameSpace));
	}
	...
	public void setServerNameSpace(String newServerNameSpace) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.WSDL_SCHEMA_CONNECTION__SERVER_NAME_SPACE, oldPortName, serverNameSpace));
	}
