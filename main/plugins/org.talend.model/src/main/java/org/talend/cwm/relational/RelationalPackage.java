...
public interface RelationalPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int TD_SQL_DATA_TYPE__JAVA_DATA_TYPE = orgomg.cwm.resource.relational.RelationalPackage.SQL_SIMPLE_TYPE_FEATURE_COUNT
			+ 0;
	 ...
	 * @ordered
	 */
	int TD_SQL_DATA_TYPE__UNSIGNED_ATTRIBUTE = orgomg.cwm.resource.relational.RelationalPackage.SQL_SIMPLE_TYPE_FEATURE_COUNT
			+ 2;
	 ...
	 * @ordered
	 */
	int TD_SQL_DATA_TYPE__CASE_SENSITIVE = orgomg.cwm.resource.relational.RelationalPackage.SQL_SIMPLE_TYPE_FEATURE_COUNT
			+ 3;
	 ...
	 * @ordered
	 */
	int TD_SQL_DATA_TYPE__AUTO_INCREMENT = orgomg.cwm.resource.relational.RelationalPackage.SQL_SIMPLE_TYPE_FEATURE_COUNT
			+ 4;
	 ...
	 * @ordered
	 */
	int TD_SQL_DATA_TYPE__LOCAL_TYPE_NAME = orgomg.cwm.resource.relational.RelationalPackage.SQL_SIMPLE_TYPE_FEATURE_COUNT
			+ 5;
	 ...
	 * @ordered
	 */
	int TD_SQL_DATA_TYPE__SEARCHABLE = orgomg.cwm.resource.relational.RelationalPackage.SQL_SIMPLE_TYPE_FEATURE_COUNT
			+ 6;
	 ...
	 * @ordered
	 */
	int TD_SQL_DATA_TYPE_FEATURE_COUNT = orgomg.cwm.resource.relational.RelationalPackage.SQL_SIMPLE_TYPE_FEATURE_COUNT
			+ 7;
