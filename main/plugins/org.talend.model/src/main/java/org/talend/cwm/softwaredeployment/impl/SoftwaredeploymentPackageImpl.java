...
public class SoftwaredeploymentPackageImpl extends EPackageImpl implements SoftwaredeploymentPackage {
	...
	public static SoftwaredeploymentPackage init() {
		if (isInited)
			return (SoftwaredeploymentPackage) EPackage.Registry.INSTANCE
					.getEPackage(SoftwaredeploymentPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredSoftwaredeploymentPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		SoftwaredeploymentPackageImpl theSoftwaredeploymentPackage = registeredSoftwaredeploymentPackage instanceof SoftwaredeploymentPackageImpl
				? (SoftwaredeploymentPackageImpl) registeredSoftwaredeploymentPackage
	...
	public void initializePackageContents() {
		...
		initEClass(tdMachineEClass, TdMachine.class, "TdMachine", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
	}
