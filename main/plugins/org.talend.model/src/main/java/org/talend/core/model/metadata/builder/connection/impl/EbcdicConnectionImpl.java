...
public class EbcdicConnectionImpl extends FileConnectionImpl implements EbcdicConnection {
	...
	public void setMidFile(String newMidFile) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.EBCDIC_CONNECTION__MID_FILE,
					oldMidFile, midFile));
	}
	...
	public void setDataFile(String newDataFile) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.EBCDIC_CONNECTION__DATA_FILE,
	...
	public void setCodePage(String newCodePage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.EBCDIC_CONNECTION__CODE_PAGE,
	...
	public void setSourceFileStart(String newSourceFileStart) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.EBCDIC_CONNECTION__SOURCE_FILE_START, oldSourceFileStart, sourceFileStart));
	}
	...
	public boolean eIsSet(int featureID) {
		...
		case ConnectionPackage.EBCDIC_CONNECTION__SOURCE_FILE_END:
			return SOURCE_FILE_END_EDEFAULT == null ? sourceFileEnd != null
					: !SOURCE_FILE_END_EDEFAULT.equals(sourceFileEnd);
		}
