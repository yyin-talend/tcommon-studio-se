...
public class SAPIDocUnitImpl extends AbstractMetadataObjectImpl implements SAPIDocUnit {
	...
	public void setConnection(SAPConnection newConnection) {
		if (newConnection != eInternalContainer()
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.SAPI_DOC_UNIT__CONNECTION,
	...
	public void setProgramId(String newProgramId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.SAPI_DOC_UNIT__PROGRAM_ID,
	...
	public void setHtmlFile(String newHtmlFile) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.SAPI_DOC_UNIT__HTML_FILE,
					oldHtmlFile, htmlFile));
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case ConnectionPackage.SAPI_DOC_UNIT__CONNECTION:
			return eInternalContainer().eInverseRemove(this, ConnectionPackage.SAP_CONNECTION__IDOCS,
					SAPConnection.class, msgs);
		}
	...
	public boolean eIsSet(int featureID) {
		...
		case ConnectionPackage.SAPI_DOC_UNIT__GATEWAY_SERVICE:
			return GATEWAY_SERVICE_EDEFAULT == null ? gatewayService != null
					: !GATEWAY_SERVICE_EDEFAULT.equals(gatewayService);
		case ConnectionPackage.SAPI_DOC_UNIT__USE_XML_OUTPUT:
