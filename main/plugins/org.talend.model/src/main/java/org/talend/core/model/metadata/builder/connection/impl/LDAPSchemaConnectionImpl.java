...
public class LDAPSchemaConnectionImpl extends ConnectionImpl implements LDAPSchemaConnection {
	...
	public void setHost(String newHost) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.LDAP_SCHEMA_CONNECTION__HOST,
					oldHost, host));
	}
	...
	public void setPort(String newPort) {
		...
		port = newPort;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.LDAP_SCHEMA_CONNECTION__PORT,
					oldPort, port));
	}
	...
	public void setFilter(String newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.LDAP_SCHEMA_CONNECTION__FILTER,
					oldFilter, filter));
	}
	...
	public void setUseAdvanced(boolean newUseAdvanced) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.LDAP_SCHEMA_CONNECTION__USE_ADVANCED, oldUseAdvanced, useAdvanced));
	}
	...
	public void setBindPrincipal(String newBindPrincipal) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.LDAP_SCHEMA_CONNECTION__BIND_PRINCIPAL, oldBindPrincipal, bindPrincipal));
	}
	...
	public void setBindPassword(String newBindPassword) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.LDAP_SCHEMA_CONNECTION__BIND_PASSWORD, oldBindPassword, bindPassword));
	}
	...
	public EList<String> getValue() {
		if (value == null) {
			value = new EDataTypeUniqueEList<String>(String.class, this,
					ConnectionPackage.LDAP_SCHEMA_CONNECTION__VALUE);
		}
		return value;
	}
	...
	public void setSavePassword(boolean newSavePassword) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.LDAP_SCHEMA_CONNECTION__SAVE_PASSWORD, oldSavePassword, savePassword));
	}
	...
	public void setAliases(String newAliases) {
		...
		aliases = newAliases;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.LDAP_SCHEMA_CONNECTION__ALIASES,
					oldAliases, aliases));
	}
	...
	public void setTimeOutLimit(String newTimeOutLimit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.LDAP_SCHEMA_CONNECTION__TIME_OUT_LIMIT, oldTimeOutLimit, timeOutLimit));
	}
	...
	public EList<String> getBaseDNs() {
		if (baseDNs == null) {
			baseDNs = new EDataTypeUniqueEList<String>(String.class, this,
					ConnectionPackage.LDAP_SCHEMA_CONNECTION__BASE_DNS);
		}
		return baseDNs;
	}
	...
	public void setGetBaseDNsFromRoot(boolean newGetBaseDNsFromRoot) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.LDAP_SCHEMA_CONNECTION__GET_BASE_DNS_FROM_ROOT, oldGetBaseDNsFromRoot,
					getBaseDNsFromRoot));
	}
	...
	public boolean eIsSet(int featureID) {
		...
		case ConnectionPackage.LDAP_SCHEMA_CONNECTION__BIND_PRINCIPAL:
			return BIND_PRINCIPAL_EDEFAULT == null ? bindPrincipal != null
					: !BIND_PRINCIPAL_EDEFAULT.equals(bindPrincipal);
		case ConnectionPackage.LDAP_SCHEMA_CONNECTION__BIND_PASSWORD:
		...
		case ConnectionPackage.LDAP_SCHEMA_CONNECTION__TIME_OUT_LIMIT:
			return TIME_OUT_LIMIT_EDEFAULT == null ? timeOutLimit != null
					: !TIME_OUT_LIMIT_EDEFAULT.equals(timeOutLimit);
		case ConnectionPackage.LDAP_SCHEMA_CONNECTION__BASE_DNS:
