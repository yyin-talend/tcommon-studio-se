...
public class ConceptTargetImpl extends EObjectImpl implements ConceptTarget {
	...
	public void setSchema(Concept newSchema) {
		if (newSchema != eInternalContainer()
			...
			if (newSchema != null)
				msgs = ((InternalEObject) newSchema).eInverseAdd(this, ConnectionPackage.CONCEPT__CONCEPT_TARGETS,
						Concept.class, msgs);
	...
	public void setTargetName(String newTargetName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.CONCEPT_TARGET__TARGET_NAME,
	...
	public void setRelativeLoopExpression(String newRelativeLoopExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.CONCEPT_TARGET__RELATIVE_LOOP_EXPRESSION, oldRelativeLoopExpression,
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case ConnectionPackage.CONCEPT_TARGET__SCHEMA:
			return eInternalContainer().eInverseRemove(this, ConnectionPackage.CONCEPT__CONCEPT_TARGETS, Concept.class,
					msgs);
		}
