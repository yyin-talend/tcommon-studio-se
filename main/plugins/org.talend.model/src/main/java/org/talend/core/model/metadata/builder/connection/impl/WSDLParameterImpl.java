...
public class WSDLParameterImpl extends EObjectImpl implements WSDLParameter {
	...
	public void setSource(String newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.WSDL_PARAMETER__SOURCE, oldSource,
					source));
	}
	...
	public void setColumn(String newColumn) {
		...
		column = newColumn;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.WSDL_PARAMETER__COLUMN, oldColumn,
					column));
	}
	...
	public void setExpression(String newExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.WSDL_PARAMETER__EXPRESSION,
	...
	public void setParameterInfoParent(String newParameterInfoParent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.WSDL_PARAMETER__PARAMETER_INFO_PARENT, oldParameterInfoParent,
					parameterInfoParent));
	}
	...
	public boolean eIsSet(int featureID) {
		...
		case ConnectionPackage.WSDL_PARAMETER__PARAMETER_INFO:
			return PARAMETER_INFO_EDEFAULT == null ? parameterInfo != null
					: !PARAMETER_INFO_EDEFAULT.equals(parameterInfo);
		case ConnectionPackage.WSDL_PARAMETER__PARAMETER_INFO_PARENT:
