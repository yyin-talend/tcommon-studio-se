			...
			if (outputRoot != oldOutputRoot) {
				...
				if (newOutputRoot.eInternalContainer() == null) {
					msgs = newOutputRoot.eInverseAdd(this,
							EOPPOSITE_FEATURE_BASE - ConnectionPackage.SAP_FUNCTION_PARAM_DATA__OUTPUT_ROOT, null,
							msgs);
				}
				if (msgs != null)
					msgs.dispatch();
	...
	public void setOutputRoot(SAPFunctionParameter newOutputRoot) {
		if (newOutputRoot != outputRoot) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.SAP_FUNCTION_PARAM_DATA__OUTPUT_ROOT, newOutputRoot, newOutputRoot));
	}
