...
public class MDMConnectionImpl extends ConnectionImpl implements MDMConnection {
	...
	public void setUsername(String newUsername) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.MDM_CONNECTION__USERNAME,
	...
	public void setPassword(String newPassword) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.MDM_CONNECTION__PASSWORD,
	...
	public void setPort(String newPort) {
		...
		port = newPort;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.MDM_CONNECTION__PORT, oldPort,
					port));
	}
	...
	public void setServer(String newServer) {
		...
		server = newServer;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.MDM_CONNECTION__SERVER, oldServer,
					server));
	}
	...
	public void setUniverse(String newUniverse) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.MDM_CONNECTION__UNIVERSE,
	...
	public void setDatamodel(String newDatamodel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.MDM_CONNECTION__DATAMODEL,
					oldDatamodel, datamodel));
	}
	...
	public void setDatacluster(String newDatacluster) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.MDM_CONNECTION__DATACLUSTER,
	...
	public void setProtocol(MDMConnectionProtocol newProtocol) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.MDM_CONNECTION__PROTOCOL,
	...
	public String getConnectionString() {
		return getProtocol().getLiteral() + "://" + getServer() + (getPort() != null ? ":" + getPort() : "") + "/" //$NON-NLS-1$//$NON-NLS-2$//$NON-NLS-3$//$NON-NLS-4$
				+ getContext();
	}
	...
	public void setServerUrl(String newServerUrl) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.MDM_CONNECTION__SERVER_URL,
