...
public class XmlXPathLoopDescriptorImpl extends EObjectImpl implements XmlXPathLoopDescriptor {
	...
	public void setLimitBoucle(Integer newLimitBoucle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.XML_XPATH_LOOP_DESCRIPTOR__LIMIT_BOUCLE, oldLimitBoucle, limitBoucle));
	}
	...
	public NotificationChain basicSetConnection(XmlFileConnection newConnection, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newConnection,
				ConnectionPackage.XML_XPATH_LOOP_DESCRIPTOR__CONNECTION, msgs);
		return msgs;
	}
	...
	public void setConnection(XmlFileConnection newConnection) {
		if (newConnection != eInternalContainer()
				|| (eContainerFeatureID() != ConnectionPackage.XML_XPATH_LOOP_DESCRIPTOR__CONNECTION
						&& newConnection != null)) {
			...
			if (newConnection != null)
				msgs = ((InternalEObject) newConnection).eInverseAdd(this,
						ConnectionPackage.XML_FILE_CONNECTION__SCHEMA, XmlFileConnection.class, msgs);
			msgs = basicSetConnection(newConnection, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.XML_XPATH_LOOP_DESCRIPTOR__CONNECTION, newConnection, newConnection));
	}
	...
	public EList<SchemaTarget> getSchemaTargets() {
		if (schemaTargets == null) {
			schemaTargets = new EObjectContainmentWithInverseEList.Resolving<SchemaTarget>(SchemaTarget.class, this,
					ConnectionPackage.XML_XPATH_LOOP_DESCRIPTOR__SCHEMA_TARGETS,
					ConnectionPackage.SCHEMA_TARGET__SCHEMA);
		}
