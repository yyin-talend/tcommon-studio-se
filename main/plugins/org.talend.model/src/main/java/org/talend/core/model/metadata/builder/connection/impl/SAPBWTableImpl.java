...
public class SAPBWTableImpl extends SAPTableImpl implements SAPBWTable {
	...
	public void setModelType(String newModelType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.SAPBW_TABLE__MODEL_TYPE,
	...
	public void setActive(boolean newActive) {
		...
		active = newActive;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.SAPBW_TABLE__ACTIVE, oldActive,
					active));
	}
	...
	public void setInfoAreaName(String newInfoAreaName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.SAPBW_TABLE__INFO_AREA_NAME,
					oldInfoAreaName, infoAreaName));
	}
	...
	public void setInnerIOType(String newInnerIOType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.SAPBW_TABLE__INNER_IO_TYPE,
					oldInnerIOType, innerIOType));
	}
	...
	public boolean eIsSet(int featureID) {
		...
		case ConnectionPackage.SAPBW_TABLE__INFO_AREA_NAME:
			return INFO_AREA_NAME_EDEFAULT == null ? infoAreaName != null
					: !INFO_AREA_NAME_EDEFAULT.equals(infoAreaName);
		case ConnectionPackage.SAPBW_TABLE__INNER_IO_TYPE:
