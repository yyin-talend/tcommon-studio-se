...
public class FileExcelConnectionImpl extends FileConnectionImpl implements FileExcelConnection {
	...
	public void setThousandSeparator(String newThousandSeparator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.FILE_EXCEL_CONNECTION__THOUSAND_SEPARATOR, oldThousandSeparator,
					thousandSeparator));
	}
	...
	public void setDecimalSeparator(String newDecimalSeparator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.FILE_EXCEL_CONNECTION__DECIMAL_SEPARATOR, oldDecimalSeparator, decimalSeparator));
	}
	...
	public void setAdvancedSpearator(boolean newAdvancedSpearator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.FILE_EXCEL_CONNECTION__ADVANCED_SPEARATOR, oldAdvancedSpearator,
					advancedSpearator));
	}
	...
	public void setSelectAllSheets(boolean newSelectAllSheets) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.FILE_EXCEL_CONNECTION__SELECT_ALL_SHEETS, oldSelectAllSheets, selectAllSheets));
	}
	...
	public void setGenerationMode(String newGenerationMode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.FILE_EXCEL_CONNECTION__GENERATION_MODE, oldGenerationMode, generationMode));
	}
	...
	public boolean eIsSet(int featureID) {
		...
		case ConnectionPackage.FILE_EXCEL_CONNECTION__GENERATION_MODE:
			return GENERATION_MODE_EDEFAULT == null ? generationMode != null
					: !GENERATION_MODE_EDEFAULT.equals(generationMode);
		}
