...
public class EDIFACTConnectionImpl extends ConnectionImpl implements EDIFACTConnection {
	...
	public void setXmlName(String newXmlName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.EDIFACT_CONNECTION__XML_NAME,
					oldXmlName, xmlName));
	}
	...
	public void setFileName(String newFileName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.EDIFACT_CONNECTION__FILE_NAME,
	...
	public void setXmlPath(String newXmlPath) {
		...
		xmlPath = newXmlPath;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.EDIFACT_CONNECTION__XML_PATH,
					oldXmlPath, xmlPath));
	}
