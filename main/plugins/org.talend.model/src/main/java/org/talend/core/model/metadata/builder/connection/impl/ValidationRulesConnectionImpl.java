...
public class ValidationRulesConnectionImpl extends ConnectionImpl implements ValidationRulesConnection {
	...
	public void setIsSelect(boolean newIsSelect) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.VALIDATION_RULES_CONNECTION__IS_SELECT, oldIsSelect, isSelect));
	}
	...
	public void setIsInsert(boolean newIsInsert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.VALIDATION_RULES_CONNECTION__IS_INSERT, oldIsInsert, isInsert));
	}
	...
	public void setIsUpdate(boolean newIsUpdate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.VALIDATION_RULES_CONNECTION__IS_UPDATE, oldIsUpdate, isUpdate));
	}
	...
	public void setIsDelete(boolean newIsDelete) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.VALIDATION_RULES_CONNECTION__IS_DELETE, oldIsDelete, isDelete));
	}
	...
	public void setType(RuleType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.VALIDATION_RULES_CONNECTION__TYPE,
					oldType, type));
	}
	...
	public void setBaseSchema(String newBaseSchema) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.VALIDATION_RULES_CONNECTION__BASE_SCHEMA, oldBaseSchema, baseSchema));
	}
	...
	public void setRefSchema(String newRefSchema) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.VALIDATION_RULES_CONNECTION__REF_SCHEMA, oldRefSchema, refSchema));
	}
	...
	public void setJavaCondition(String newJavaCondition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.VALIDATION_RULES_CONNECTION__JAVA_CONDITION, oldJavaCondition, javaCondition));
	}
	...
	public void setSqlCondition(String newSqlCondition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.VALIDATION_RULES_CONNECTION__SQL_CONDITION, oldSqlCondition, sqlCondition));
	}
	...
	public void setLogicalOperator(LogicalOperator newLogicalOperator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.VALIDATION_RULES_CONNECTION__LOGICAL_OPERATOR, oldLogicalOperator,
					logicalOperator));
	}
	...
	public EMap<String, String> getInnerJoins() {
		if (innerJoins == null) {
			innerJoins = new EcoreEMap<String, String>(ConnectionPackage.Literals.INNER_JOIN_MAP,
					InnerJoinMapImpl.class, this, ConnectionPackage.VALIDATION_RULES_CONNECTION__INNER_JOINS);
		}
		return innerJoins;
	}
	...
	public void setIsDisallow(boolean newIsDisallow) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.VALIDATION_RULES_CONNECTION__IS_DISALLOW, oldIsDisallow, isDisallow));
	}
	...
	public void setIsRejectLink(boolean newIsRejectLink) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConnectionPackage.VALIDATION_RULES_CONNECTION__IS_REJECT_LINK, oldIsRejectLink, isRejectLink));
	}
	...
	public boolean eIsSet(int featureID) {
		...
		case ConnectionPackage.VALIDATION_RULES_CONNECTION__JAVA_CONDITION:
			return JAVA_CONDITION_EDEFAULT == null ? javaCondition != null
					: !JAVA_CONDITION_EDEFAULT.equals(javaCondition);
		case ConnectionPackage.VALIDATION_RULES_CONNECTION__SQL_CONDITION:
