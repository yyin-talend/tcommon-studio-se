/*******************************************************************************
 * Copyright (c) 2010, 2013 Sonatype, Inc. All rights reserved. This program and the accompanying materials are made
...
public class ConsoleDependencyGraphDumper implements DependencyVisitor {
    ...
    public ConsoleDependencyGraphDumper(PrintWriter out) {
        this(out, "");
    }

    public ConsoleDependencyGraphDumper(PrintWriter out, String tab) {
        this.out = out;
        if (tab != null) {
            this.tab = tab;
        } else {
    ...
    public boolean visitEnter(DependencyNode node) {
        out.println(tab + formatIndentation() + formatNode(node));
